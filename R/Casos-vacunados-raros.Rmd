...
date: '`r paste("Actualizado el", format(Sys.Date(), "%d de %B del %Y"), "con datos de la SINAVE")`'
output:
  html_document:
    fig_retina: 1
    theme:
...
sinave = arrow::read_parquet("../Data/BASE YUC 20 SEPT.parquet", encoding = "UTF-8", stringsAsFactors = FALSE)
